...
* chuckrum.conf: contains configuration settings for chuckrumd or chuckrum-qt
* chuckrumd.pid: stores the process id of chuckrumd while running
...
* debug.log: contains debug information and general logging generated by chuckrumd or chuckrum-qt
