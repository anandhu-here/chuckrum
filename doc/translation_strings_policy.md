...
This document provides guidelines for internationalization of the Chuckrum Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `chuckrum_en.ts` remains unchanged.
