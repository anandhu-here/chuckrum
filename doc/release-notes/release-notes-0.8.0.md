Chuckrum-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/chuckrum/files/Chuckrum/chuckrum-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Chuckrum
...
New/changed settings (command-line or chuckrum.conf file)
--------------------------------------------------------
