Chuckrum version 0.5.0 is now available for download at:
http://sourceforge.net/projects/chuckrum/files/Chuckrum/chuckrum-0.5.0/
...
For Ubuntu users, there is a new ppa maintained by Matt Corallo which you can add to your system so that it will automatically keep chuckrum up-to-date.  Just type "sudo apt-add-repository ppa:chuckrum/chuckrum" in your terminal, then install the chuckrum-qt package.
...
If you have a previously encrypted wallet.dat, the first time you run chuckrum-qt or chuckrumd the wallet will be rewritten, Chuckrum will
...
Chuckrum-Qt: Address Book, then New Address...
...
Drag and drop support for chuckrum: URIs on web pages.
...
signmessage/verifymessage : new RPC commands to sign a message with one of your private keys or verify that a message signed by the private key associated with a chuckrum address.
