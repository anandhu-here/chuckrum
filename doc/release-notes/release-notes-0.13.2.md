Chuckrum Core version 0.13.2 is now available from:

  <https://chuckrum.org/bin/chuckrum-core-0.13.2/>
...
- #8908 `4a974b2` Update chuckrum-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow chuckrum-tx to create v2 transactions (btcdrak)
