Chuckrum version 0.5.4 is now available for download at:
http://sourceforge.net/projects/chuckrum/files/Chuckrum/chuckrum-0.5.4/
...
http://gitorious.org/chuckrum/chuckrumd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Chuckrum-Qt notifications under Growl 1.3.
Increase required age of Chuckrum-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxChuckrum properly when installing Chuckrum-Qt over it. (Windows)
