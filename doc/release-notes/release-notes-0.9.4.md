Chuckrum Core version 0.9.4 is now available from:

  https://chuckrum.org/bin/0.9.4/
...
this update is incompatible with the Chuckrum system and could lead to consensus
forks.

Chuckrum Core released binaries from https://chuckrum.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~chuckrum/+archive/ubuntu/chuckrum
- A third-party or self-compiled Chuckrum Core

upgrade to Chuckrum Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
