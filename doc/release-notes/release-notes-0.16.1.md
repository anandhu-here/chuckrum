Chuckrum Core version 0.16.1 is now available from:

  <https://chuckrumcore.org/bin/chuckrum-core-0.16.1/>
...
- #12843 `df38b13` Test starting chuckrumd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure chuckrumd processes are cleaned up when tests end (sdaftuar)
