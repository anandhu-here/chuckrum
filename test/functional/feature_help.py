...
"""Verify that starting chuckrum with -h works as expected."""

from test_framework.test_framework import ChuckrumTestFramework
from test_framework.util import assert_equal

class HelpTest(ChuckrumTestFramework):
    ...
    def run_test(self):
        self.log.info("Start chuckrum with -h for help text")
        ...
        self.log.info("Start chuckrum with -version for version information")
        ...
        self.log.info("Start chuckrumd with -fakearg to make sure it does not start")
