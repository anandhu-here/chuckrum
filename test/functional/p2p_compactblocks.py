...
# TestP2PConn: A peer we use to send messages to chuckrumd, and store responses.
...
class CompactBlocksTest(ChuckrumTestFramework):
    ...
    # This test actually causes chuckrumd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that chuckrumd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for chuckrumd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # chuckrumd will not send blocktxn responses for blocks whose height is
