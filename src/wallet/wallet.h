...
#ifndef CHUCKRUM_WALLET_WALLET_H
#define CHUCKRUM_WALLET_WALLET_H
...
public:
     ...
     * on this chuckrum node, and set to 0 for transactions that were created
...
#endif // CHUCKRUM_WALLET_WALLET_H
