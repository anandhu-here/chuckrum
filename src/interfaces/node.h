...
#ifndef CHUCKRUM_INTERFACES_NODE_H
#define CHUCKRUM_INTERFACES_NODE_H
...
//! Top-level interface for a chuckrum node (chuckrumd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // CHUCKRUM_INTERFACES_NODE_H
