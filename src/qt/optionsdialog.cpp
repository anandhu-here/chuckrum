    ...
    mapper(0)
{
    ...
    ui->chuckrumAtStartup->setToolTip(ui->chuckrumAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->chuckrumAtStartup->setText(ui->chuckrumAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openChuckrumConfButton->setToolTip(ui->openChuckrumConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new ChuckrumUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->chuckrumAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openChuckrumConfButton_clicked()
{
