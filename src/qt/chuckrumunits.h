...
#ifndef CHUCKRUM_QT_CHUCKRUMUNITS_H
#define CHUCKRUM_QT_CHUCKRUMUNITS_H
...
/** Chuckrum unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ChuckrumUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ChuckrumUnits(QObject *parent);

    /** Chuckrum units.
      @note Source: https://en.chuckrum.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CKM,
...
typedef ChuckrumUnits::Unit ChuckrumUnit;

#endif // CHUCKRUM_QT_CHUCKRUMUNITS_H
