...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 150154;
...
public:
    CTestNetParams() {
        ...
        // vSeeds.emplace_back("testnet-seed.chuckrum.jonasschnelli.ch");
        // vSeeds.emplace_back("seed.tbtc.petertodd.org");
        // vSeeds.emplace_back("seed.testnet.chuckrum.sprovoost.nl");
