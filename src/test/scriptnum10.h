...
#ifndef CHUCKRUM_TEST_SCRIPTNUM10_H
#define CHUCKRUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Chuckrum Core 0.10.0, for cross-comparison.
 */
public:
