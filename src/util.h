 ...
 */
#ifndef CHUCKRUM_UTIL_H
#define CHUCKRUM_UTIL_H
...
extern const char * const CHUCKRUM_CONF_FILENAME;
extern const char * const CHUCKRUM_PID_FILENAME;
...
{
    std::string s = strprintf("chuckrum-%s", name);
