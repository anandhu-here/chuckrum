...
static void SetupChuckrumTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " chuckrum-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  chuckrum-tx [options] <hex-tx> [commands]  Update hex-encoded chuckrum transaction\n" +
            "or:     chuckrum-tx [options] -create [commands]   Create hex-encoded chuckrum transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded chuckrum transaction
